 ...
 * React Hook para usar EventReporter
 * ========================================
 */

import { useEffect, useCallback } from 'react';
import { getEventReporter, reportError, reportUserActivity, reportApiError } from '../eventReporter';
import type { EventSeverity, EventOrigin } from '../eventReporter';
...
export function useActivityTracker() {
  ...
  useEffect(() => {
    ...
    const getUserId = () => {
      // Adaptar según tu sistema de auth
